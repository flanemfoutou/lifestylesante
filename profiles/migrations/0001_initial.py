# Generated by Django 4.2.16 on 2024-10-17 14:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('F', 'Feminin'), ('M', 'Masculin')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(upload_to='images_connexion')),
